import { Code2, Palette, Server, Smartphone, Brain, Database, Shield } from 'lucide-react';

export const roadmaps = [
  {
    id: 'frontend',
    title: 'Frontend Development',
    description: 'Learn to build modern web interfaces with HTML, CSS, JavaScript, and React',
    icon: Code2,
